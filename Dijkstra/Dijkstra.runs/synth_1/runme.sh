...
HD_PWD='C:/Users/olafu/Desktop/SDUP/PROJEKT/SDUP_Dijkstra/Dijkstra/Dijkstra.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dijkstra_rtl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dijkstra_rtl.tcl
