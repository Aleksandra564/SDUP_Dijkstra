...
HD_PWD='C:/Users/olafu/Desktop/SDUP/PROJEKT/SDUP_Dijkstra/Dijkstra/Dijkstra.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dijkstra_rtl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dijkstra_rtl.tcl -notrace
