...
HD_PWD='C:/Users/olafu/Desktop/SDUP/PROJEKT/SDUP_Dijkstra/ip_repo/edit_dijkstra_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dijkstra_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dijkstra_ip_v1_0.tcl
